          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height:24,),
                Stack(children: [
               unit8file!=null?CircleAvatar(

                    backgroundImage: MemoryImage(unit8file!),
                    radius: 64.0,
                  )  : CircleAvatar(

                    backgroundImage: NetworkImage("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSed2qIEOqQ1Fyc1RQgJ88ZzVwQ8bOaCRlUig&usqp=CAU"),
                    radius: 64.0,
                  ),
                  Positioned(
                    bottom: 0,
                ...
                SizedBox(height:24,),
                Textinput(textEditingController: userNameController,hintext: "Enter your name",textInputType: TextInputType.text,),
                SizedBox(height:24,),
                ...
                Textinput(textEditingController: passWordController,hintext: "Enter your password",textInputType: TextInputType.text,isPass: true,),
                 SizedBox(height: 24,),
                  ...
                  Textinput(textEditingController: bioController,hintext: "Enter your bio",textInputType: TextInputType.text,),
                  SizedBox(height: 24,),
                InkWell(
                  onTap: () async{
                    String res=await AuthMethods().signUpWithUser(email:emailController.text, password: passWordController.text, username: userNameController.text, bio: bioController.text);
                    print(res);
                  },
